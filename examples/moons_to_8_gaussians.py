...
def main():
    ...
    plot_mtransport_validation_2d(res, mu0, mu1, nsim=256, key=ksim, bins=32, usetex=True, save_prefix="./examples/moons_to_8_gaussians", show=False, nticks=2, ax_lims=ax_lims)
