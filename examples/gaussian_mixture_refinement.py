...
def main():
    ...
    plot_mtransport_validation_2d(res, mu0, mu1, nsim=256, key=ksim, bins = 32, usetex=True, save_prefix="./examples/gaussian_mixture_refinement", show=False, max_step=1, ax_lims=ax_lims)
